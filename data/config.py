...
PAYMENT_MESSAGE_TOPIC_ID = env.int("PAYMENT_MESSAGE_TOPIC_ID")
DRIVERS = env.int("DRIVERS")

CARD_NUMBER = env.str("CARD_NUMBER")
CARDHOLDER = env.str("CARDHOLDER")
PAYMENT_AMOUNT = env.str("PAYMENT_AMOUNT")  # in UZS
